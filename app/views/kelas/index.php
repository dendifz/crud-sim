...
<div class="row">
    <div class="col-sm-12">
      ...
      <div class="card-header">
          <h3 class="card-title"><?= $data['title'] ?></h3> <div class="btn-group float-right"><a href="<?= base_url; ?>/kelas/tambah" class="btn float-right btn-xs btn btn-primary">Tambah Data kelas</a><a href="<?= base_url; ?>/kelas/laporan" class="btn float-right btn-xs btn btn-info">Laporan kelas</a><a href="<?= base_url; ?>/kelas/lihatlaporan" class="btn float-right btn-xs btn btn-warning">Lihat Laporan kelas</a></div>
        </div>
        <div class="card-body">
