    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><?= $data['title'] ?></h3> <div class="btn-group float-right"><a href="<?= base_url; ?>/jamkuliah/tambah" class="btn float-right btn-xs btn btn-primary">Tambah Jam Kuliah</a></div>
        </div>
        <div class="card-body">
